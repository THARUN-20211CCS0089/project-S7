...
const Dashboard = () => {
  ...
  return (
    <div className ='dashboard-main-container'>
      {/* section1 */}
      <marquee>BYOD</marquee>
      <div className='section1-container'>
        <div className='section1-data'>
        <h1 className ='section1-title'>Build the Future of Safe and Productive Classrooms</h1>
        <p className ='section1-desc'>Enhancing Learning and Security Through Technology</p>
        <p className ='section1-desc'>We are committed to shaping a future where technology elevates <br/> educational experiences, providing tools that prioritize both learning and safety.</p>
       </div>
       <img className='section1-image' src='https://img.freepik.com/free-vector/students-with-computer-classroom-elements-white-background_1308-52052.jpg?t=st=1728107791~exp=1728111391~hmac=0c484eb3d714dbd6934d7450aadae8fcbb90b9069f3efc1b1b476f2bd4163e76&w=1380' alt='classroom image'/>
      </div>
      {/* section2 */}
      <div className='section2-container'>
      <h1 className ='section2-main-title'>A New Era of Education Awaits</h1>
        <div className='section2-data'>
          
          <h1 className ='section2-title'>Shaping the Future, One Classroom at a Time</h1>
            <p className ='section2-desc'>Our platform is more than a tool; it’s a bridge to a brighter, more inclusive educational future. By empowering educators and protecting students, we are creating a world where every child has the opportunity to thrive—whether in the classroom or online.</p>
      ...
      <div className="p-4 bg-transparent ">
        ...
        <img className="system-uptime-image" alt='system uptime logo' src='https://cdn-icons-png.freepik.com/256/12124/12124378.png?ga=GA1.1.462727108.1735301062&semt=ais_hybrid'/>
...
const NetworkManagementPortal = () => {
  ...
  return (
    <>
      {/* Sticky Header */}
      <div className="bg-white shadow-md sticky top-0 flex items-center">
        {[
        ...
        <button
          ...
          className="ml-auto p-4 text-red-600 flex items-center"
        >
